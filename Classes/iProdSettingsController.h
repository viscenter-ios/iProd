...
//
//This class controls the view that allows the user to specifies settings for the iProdTimerController.

#import <UIKit/UIKit.h>
#import <CoreData/CoreData.h>

@interface iProdSettingsController : UIViewController <UITextFieldDelegate> {
    ...
    UITextField *intervalText;          //text field for interval duration
