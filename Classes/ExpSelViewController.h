...
//
//This view controller contains the table which is generated from the experiments stored
//using Core Data. It allows the user to either delete experiments that are currently on
//the device or email out (in csv format) the data of a given experiment.

#import <UIKit/UIKit.h>
#import "iProd2AppDelegate.h"
#import <MessageUI/MessageUI.h>
//The interface MFMailComposeViewControllerDelegate allows for pushing the modal
//mail view. This is used to email out the csv from the device.
